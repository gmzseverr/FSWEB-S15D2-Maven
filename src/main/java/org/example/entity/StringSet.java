...
public class StringSet {
    ...
    public static Set<String> findUniqueWords(){
        String text = "Carroll began writing the manuscript of the story the next day, although that earliest version is lost. "
                + "The girls and Carroll took another boat trip a month later, when he elaborated the " +
                "plot to the story of Alice, " + "and in November he began working on the manuscript in earnest. " +
                "To add the finishing touches he researched " + "natural history in connection with the animals " +
                "presented in the book and then had the book examined " + "by other children—particularly those " +
                "of George MacDonald. Though Carroll did add his own illustrations " + "to the original copy, " +
